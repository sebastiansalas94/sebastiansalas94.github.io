...
on behavioral patterns observed in gameplay data. The game’s design allows 
for free-form deckbuilding alongside random events, offering insight into 
how players manage uncertainty, resources, and strategic choices. 
Understanding these patterns can inform the design of Slay the Spire 2, 
helping developers tailor features to different types of players. 
We analyze actions such as card selection, combat goals, risk-taking, 
and resource use. 
...
<object data="/projects/AnalyzeTheSpire.pdf" type="application/pdf" width="100%" height="800"> 
